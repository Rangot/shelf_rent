...
urlpatterns = [
    ...
    path('create_cash_nal_beznal/<int:orders_id>/<int:sell>/<int:discount>/', create_cash_nal_beznal,
         name='create_cash_nal_beznal'),
    path('view/', view, name='view'),
    path('view_tenant/<username>', view_tenant, name='view_tenant'),
    ...
    path('edit_tenant/<username>', edit_tenant, name='edit_tenant'),
    ...
    path('payment_to_tenant/<username>', payment_to_tenant, name='payment_to_tenant'),
]
